...
int main(int argc, char* argv[]) {
    ...
    // Logger::Dbg("Server started Path: " + rootDirPath.string());
    // Logger::Dbg("main:: Server starting....");
    ...
    std::cout << "Server starting on port " << 8080 << ". Threads count = " << numThreads << std::endl;
    /* Wait for threads **/
